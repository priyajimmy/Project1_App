...
namespace Project1_App
{
    public partial class Edit_Product : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            TextBox txtdescrp = (TextBox)GridView1.Rows[i].Cells[6].Controls[0];
            string strup = "update Product set Productname='" + txtname.Text + "',Productdescription='" + txtdescrp.Text + "' where Productid=" + getid + "";
